...
export function AdminHero({ stats }: AdminHeroProps) {
  return (
    <header className="overflow-hidden rounded-3xl border bg-card text-card-foreground shadow-[var(--shadow-card)]">
      <div
        aria-hidden="true"
        className="relative h-32 bg-[linear-gradient(135deg,oklch(0.70_0.13_310),oklch(0.50_0.15_295))] sm:h-44"
      >
      ...
      <div className="p-6 pt-0 sm:p-8 sm:pt-0">
        <div className="flex min-w-0 flex-col gap-5 sm:flex-row sm:items-start">
          <div className="relative z-10 -mt-14 flex size-24 shrink-0 items-center justify-center rounded-full border-4 border-card bg-secondary font-serif text-3xl font-extrabold text-primary shadow-[0_4px_12px_rgb(0_0_0/0.06)] sm:-mt-16 sm:size-28">
            AD
          </div>
